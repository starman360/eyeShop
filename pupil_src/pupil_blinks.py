...
class PupilBlinksStream(threading.Thread):
    def __init__(self, q):
        super(PupilBlinksStream, self).__init__()
        context = zmq.Context()
        self.q = q
        ...
        self.sub_info.setsockopt_string(zmq.SUBSCRIBE, 'blinks')
    ...
    def run(self):
        try:
            ...
            while True:
                ...
                print(msg['confidence'], msg['timestamp']) 
